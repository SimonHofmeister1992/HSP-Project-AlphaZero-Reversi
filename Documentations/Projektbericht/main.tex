...
\begin{flalign*}
& \hspace{-0.1 cm} \text{sudo apt-get update} \\
& \hspace{-0.1 cm} \text{sudo apt-get upgrade} \\
& \hspace{-0.1 cm} \text{sudo apt-get autoremove} \\
& \hspace{-0.1 cm} \text{// Logout und erneuten Login durchführen.} \\
\end{flalign*}
