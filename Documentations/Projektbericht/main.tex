...
Das NN (Neuronale Netz) wird innerhalb des MCTS verwendet, um Spielfelder und Spielzüge zu bewerten. Hierfür wird dem NN ein Spielfeld und der Spieler, der den nächsten Zug auf diesem Spielfeld hat, übergeben. Die Rückgabe besteht aus einer Zahl zur Bewertung des Spielfeldes und einem Array mit einer Bewertung für jede Position des Spielfeldes. In der Klasse NeuronalNet befindet sich die Definition des Modells des neuronalen Netzes. Des Weiteren fungiert die Klasse PolicyValuePredictor als Wrapper über das neuronale Netz und bietet Schnittstellen für das Laden und Speichern von Modellen, für das Training und die Evaluation von Zuständen an. Um den Input vom MCTS für das neuronale Netz zu transformieren, wird die Klasse PlaygroundTransformer genutzt. 
...
\defbibfilter{Literatur}{\not type=online} 
\defbibfilter{Quellen}{type=online} 
% ----------------------------------------------------------------------------------------------------------
% Literatur
% ----------------------------------------------------------------------------------------------------------
